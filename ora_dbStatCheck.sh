...
# ==============================================================================
# Oracle Database Multi-Instance Health Check Script for RHEL based distros (8/9 Tested)
...
if [ ${#ISSUES[@]} -eq 0 ]; then
    echo -e "${GREEN}Everything is fine:${NC} The listener is running, and all $TOTAL_DB_COUNT configured database(s) ($CHECKED_DBS_STR) are in healthy states corresponding to their roles."
    exit 0
else
